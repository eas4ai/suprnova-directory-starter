            ...
            Some(user) => {
                ...
                let can_accounts = can_admin
                    && user
                        ...
                        .await?;
                let can_seo = can_admin
                    && user
                        .has_permission_to(crate::seo::MANAGE_PERMISSION)
                        .await?;
                ...
                json!({"name": user.name, "email": user.email,
                    ...
                    "can_edit": can_edit, "can_taxonomy": can_taxonomy, "can_accounts": can_accounts, "can_audit": can_audit, "can_seo": can_seo})
            }
