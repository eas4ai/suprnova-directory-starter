...
routes! {
    ...
    group!("/admin", {
        ...
        get!("/seo", controllers::seo::index),
        post!("/seo", controllers::seo::update),
        post!("/seo/redirects", controllers::seo::redirect_store),
        post!("/seo/redirects/{id}", controllers::seo::redirect_update),
        post!("/seo/redirects/{id}/remove", controllers::seo::redirect_remove),
